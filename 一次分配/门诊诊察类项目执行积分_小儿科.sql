/* ===============================================================================
  ...
  数据流向: dbo.[PF临时医疗服务项目26A] (事实·医疗服务项目明细)
            ...
            ──▶ dbo.[DWD_FIN_CALC_ALLOC1_DETAIL_LOG] (落库 Target: ITEM_OUTPATIENT_DIAG_SCORE_PED)
  ...
  2026-09-16 18:30:00 | 架构持久化 | Envelope Pattern 双区块重构：第一区块前置幂等 DELETE（按 CALC_YEAR/CALC_MONTH/
                                   ...
                                   dbo.DWD_FIN_CALC_ALLOC1_DETAIL_LOG（ITEM_CODE='ITEM_OUTPATIENT_DIAG_SCORE_PED'，
